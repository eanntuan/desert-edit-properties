...
~~**TASK GSC-22: Title/meta rewrite on `where-to-stay-coachella-2026`**~~ ✅ **DONE 2026-07-20** — Flagged in the 2026-07-20 GSC Check-in (529 imps, 2 clicks, 0.4% CTR, 67.1% of impressions ≤ pos 20 = title/meta rewrite target). Title changed to "Coachella 2026 Lodging: What Actually Books Out First" (53 chars), meta rewritten to lead with the sold-out-first angle: "Camping, hotels, and rentals for Coachella 2026, ranked by what sells out first. I own two rentals near the polo grounds and skip the padded lists." (147 chars). This page is a redirect (`redirectTo: /blog/where-to-stay-coachella/`) so only the search snippet changes, not on-page content. dateModified bumped to 2026-07-20. Check CTR at next GSC check-in.
